...
void PolynomialTraj::waypointsTraj(const Eigen::MatrixXd& positions, const Eigen::Vector3d& start_vel,
  ...
  // Check point 1 
  std::cout << "Check point 1 in poly_traj" << std::endl;
  ...
  // Check point 2
  std::cout << "Check point 2 in poly_traj" << std::endl;
  ...
  // Check point 3
  std::cout << "Check point 3 in poly_traj" << std::endl;
  ...
  // Check point 4
  std::cout << "Check point 4 in poly_traj" << std::endl;
  ...
  // Check point 5
  std::cout << "Check point 5 in poly_traj" << std::endl;
  ...
  // Check point 6
  std::cout << "Check point 6 in poly_traj" << std::endl;
  ...
  // Check point 7
  std::cout << "Check point 7 in poly_traj" << std::endl;
  ...
  // Check point 8
  std::cout << "Check point 8 in poly_traj" << std::endl;

  Eigen::VectorXd Dxf(2 * seg_num + 4), Dyf(2 * seg_num + 4), Dzf(2 * seg_num + 4);

  // Check point 9
  std::cout << "Check point 9 in poly_traj" << std::endl;
  ...
  // Check point 10
  std::cout << "Check point 10 in poly_traj" << std::endl;
  ...
  // Check point 11
  std::cout << "Check point 11 in poly_traj" << std::endl;
  ...
  // Check point 12
  std::cout << "Check point 12 in poly_traj" << std::endl;

  // Solve the optimal free derivative in closed form

  // Check point 13
  std::cout << "Check point 13 in poly_traj" << std::endl;
  ...
  // Check point 14
  std::cout << "Check point 14 in poly_traj" << std::endl;
  ...
  // Check point 15
  std::cout << "Check point 15 in poly_traj" << std::endl;
  ...
  // Check point 16
  std::cout << "Check point 16 in poly_traj" << std::endl;
  ...
  // Check point 17
  std::cout << "Check point 17 in poly_traj" << std::endl;
