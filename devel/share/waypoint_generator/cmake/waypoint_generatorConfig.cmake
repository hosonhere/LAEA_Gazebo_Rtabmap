...
if("TRUE" STREQUAL "TRUE")
  set(waypoint_generator_SOURCE_PREFIX /home/hoson/laea_rtabmap/src/LAEA_Gazebo_Rtabmap/laea_planner/utils/waypoint_generator)
  set(waypoint_generator_DEVEL_PREFIX /home/hoson/laea_rtabmap/devel)
  ...
  set(waypoint_generator_INSTALL_PREFIX /home/hoson/laea_rtabmap/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'waypoint_generator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hoson/laea_rtabmap/src/LAEA_Gazebo_Rtabmap/laea_planner/utils/waypoint_generator/${idir}'.  ${_report}")
    endif()
