...
if("TRUE" STREQUAL "TRUE")
  set(multi_map_server_SOURCE_PREFIX /home/hoson/laea_rtabmap/src/LAEA_Gazebo_Rtabmap/laea_planner/utils/multi_map_server)
  set(multi_map_server_DEVEL_PREFIX /home/hoson/laea_rtabmap/devel)
  ...
  set(multi_map_server_INSTALL_PREFIX /home/hoson/laea_rtabmap/install)
...
if(NOT "/home/hoson/laea_rtabmap/devel/include " STREQUAL " ")
  set(multi_map_server_INCLUDE_DIRS "")
  set(_include_dirs "/home/hoson/laea_rtabmap/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multi_map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hoson/laea_rtabmap/src/LAEA_Gazebo_Rtabmap/laea_planner/utils/multi_map_server/${idir}'.  ${_report}")
    endif()
